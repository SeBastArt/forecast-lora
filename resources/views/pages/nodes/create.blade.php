        ...
        <div class="col s12 m12 l12">
            <div id="highlight-table" class="card card card-default scrollspy">
                <div class="card-content">
                    ...
                    <p class="mb-2">An overview of all nodes you add to your account. You can edit the filds by clicking in
                        the list</p>
                    <div class="row">
                        <div class="col s12">
                        </div>
                                ...
                                <tbody>
                                    @foreach ($Nodes as $node)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn-floating mb-1 btn-medium waves-effect waves-light mr-1"
                                                    onclick="confirmDelete('{{ action('Web\NodeController@destroy', ['node' => $node->id]) }}')"><i
                                                        class="material-icons">delete</i></a>
                                                <a class="btn-floating mb-1 btn-medium waves-effect waves-light mr-1"
                                                    href="nodes/{{ $node->id }}"><i class="material-icons">search</i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
